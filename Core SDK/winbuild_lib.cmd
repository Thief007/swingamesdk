...
if "%1"=="clean" goto cleaning
	...
	fpc -v0 -Mdelphi -FE"%Output%" .\src\SGSDK_Core.pas
	fpc -v0 -Mdelphi -FE"%Output%" .\src\SGSDK_Graphics.pas
	fpc -v0 -Mdelphi -FE"%Output%" .\src\SGSDK_Font.pas
	fpc -v0 -Mdelphi -FE"%Output%" .\src\SGSDK_Input.pas
	...
	fpc -v0 -Mdelphi -FE"%Output%" .\src\SGSDK_Camera.pas

...
function SDL_IntersectRect(constref A, B: TSDL_Rect; out R: TSDL_Rect): SDL_Bool; cdecl; external;
procedure SDL_UnionRect(constref A, B: TSDL_Rect; out R: TSDL_Rect); cdecl; external;
...
function SDL_PixelFormatEnumToMasks(format: Uint32; out bpp: LongInt;
  out Rmask, Gmask, Bmask, Amask: Uint32): SDL_Bool; cdecl; external;
...
procedure SDL_GetRGB(pixel: Uint32; format: PSDL_PixelFormat; out r, g, b: Uint8); cdecl; external;
procedure SDL_GetRGBA(pixel: Uint32; format: PSDL_PixelFormat; out r, g, b, a: Uint8); cdecl; external;
procedure SDL_CalculateGammaRamp(gamma: SDL_Float; out ramp: Uint16); cdecl; external;
...
function SDL_GetColorKey(surface: PSDL_Surface; out key: Uint32): LongInt; cdecl; external;
function SDL_SetSurfaceColorMod(surface: PSDL_Surface; r, g, b: Uint8): LongInt; cdecl; external;
function SDL_GetSurfaceColorMod(surface: PSDL_Surface; out r, g, b: Uint8): LongInt; cdecl; external;
...
function SDL_GetDisplayBounds(displayIndex: LongInt; out rect: TSDL_Rect): LongInt; cdecl; external;
function SDL_GetNumDisplayModes(displayIndex: LongInt): LongInt; cdecl; external;
function SDL_GetDisplayMode(displayIndex, modeIndex: LongInt; mode: PSDL_DisplayMode): LongInt; cdecl; external;
...
function SDL_GetClosestDisplayMode(displayIndex: LongInt; constref mode: TSDL_DisplayMode;
  out closest: TSDL_DisplayMode): LongInt; cdecl; external;
...
procedure SDL_GetWindowPosition(window: PSDL_Window; out x, y: LongInt); cdecl; external;
procedure SDL_SetWindowSize(window: PSDL_Window; w, h: LongInt); cdecl; external;
procedure SDL_GetWindowSize(window: PSDL_Window; out w, h: LongInt); cdecl; external;
procedure SDL_SetWindowMinimumSize(window: PSDL_Window; w, h: LongInt); cdecl; external;
procedure SDL_GetWindowMinimumSize(window: PSDL_Window; out w, h: LongInt); cdecl; external;
procedure SDL_SetWindowMaximumSize(window: PSDL_Window; w, h: LongInt); cdecl; external;
procedure SDL_GetWindowMaximumSize(window: PSDL_Window; out w, h: LongInt); cdecl; external;
...
function SDL_GetWindowGammaRamp(window: PSDL_Window; out red, green, blue: Uint16): SDL_Float; cdecl; external;
...
function SDL_GL_GetAttribute(attr: LongInt; out value: LongInt): LongInt; cdecl; external;
...
function SDL_CreateWindowAndRenderer(width, height: LongInt; window_flags: Uint32;
  out window: PSDL_Window; out renderer: PSDL_Renderer): LongInt; cdecl; external;
...
function SDL_GetRendererInfo(renderer: PSDL_Renderer; out info: TSDL_RendererInfo): LongInt; cdecl; external;
...
function SDL_QueryTexture(texture: PSDL_Texture; format: Uint32; out access, w, h: LongInt): LongInt; cdecl; external;
function SDL_SetTextureColorMod(texture: PSDL_Texture; r, g, b: Uint8): LongInt; cdecl; external;
function SDL_GetTextureColorMod(texture: PSDL_Texture; out r, g, b: Uint8): LongInt; cdecl; external;
function SDL_SetTextureAlphaMod(texture: PSDL_Texture; alpha: Uint8): LongInt; cdecl; external;
function SDL_GetTextureAlphaMod(texture: PSDL_Texture; out alpha: Uint8): LongInt; cdecl; external;
function SDL_SetTextureBlendMode(texture: PSDL_Texture; blendMode: LongInt): LongInt; cdecl; external;
function SDL_GetTextureBlendMode(texture: PSDL_Texture; out blendMode: LongInt): LongInt; cdecl; external;
...
function SDL_LockTexture(texture: PSDL_Texture; constref rect: TSDL_Rect; out pixels: Pointer; out pitch: LongInt): LongInt; cdecl; external;
...
procedure SDL_RenderGetLogicalSize(renderer: PSDL_Renderer; out w, h: LongInt); cdecl; external;
function SDL_RenderSetViewport(renderer: PSDL_Renderer; constref rect: TSDL_Rect): LongInt; cdecl; external;
procedure SDL_RenderGetViewport(renderer: PSDL_Renderer; out rect: TSDL_Rect); cdecl; external;
function SDL_RenderSetScale(renderer: PSDL_Renderer; scaleX, scaleY: SDL_Float): LongInt; cdecl; external;
procedure SDL_RenderGetScale(renderer: PSDL_Renderer; out scaleX, scaleY: SDL_Float); cdecl; external;
function SDL_SetRenderDrawColor(renderer: PSDL_Renderer; r, g, b, a: Uint8): LongInt; cdecl; external;
function SDL_GetRenderDrawColor(renderer: PSDL_Renderer; out r, g, b, a: Uint8): LongInt; cdecl; external;
function SDL_SetRenderDrawBlendMode(renderer: PSDL_Renderer; blendMode: LongInt): LongInt; cdecl; external;
function SDL_GetRenderDrawBlendMode(renderer: PSDL_Renderer; out blendMode: LongInt): LongInt; cdecl; external;
...
function SDL_RenderCopy(renderer: PSDL_Renderer; texture: PSDL_Texture; srcrect, dstrect: PSDL_Rect): LongInt; cdecl; external;
...
function SDL_GL_BindTexture(texture: PSDL_Texture; out texw, texh: SDL_Float): LongInt; cdecl; external;
...
function SDL_ShowMessageBox(constref messageboxdata: TSDL_MessageBoxData; out buttonid: LongInt): LongInt; cdecl; external;
...
function SDL_GetKeyFromScancode(scancode: Uint32): Uint32; cdecl; external;
function SDL_GetScancodeFromKey(key: Uint32): Uint32; cdecl; external;
function SDL_GetScancodeName(scancode: Uint32): SDL_Char; cdecl; external;
function SDL_GetScancodeFromName(name: SDL_Char): Uint32; cdecl; external;
...
function SDL_GetMouseState(x, y: PUint32): Uint32; cdecl; external;
function SDL_GetRelativeMouseState(out x, y: LongInt): Uint32; cdecl; external;
...
function SDL_JoystickGetBall(joystick: PSDL_Joystick; ball: LongInt; out dx, dy: LongInt): LongInt; cdecl; external;
...
function SDL_LoadDollarTemplates(touchId: TSDL_TouchID; out src: TSDL_RWops): LongInt; cdecl; external;
...
type
  ...
  SDL_Event = record
    case Integer of
      0: (_type: Uint32; timestamp: Uint32);
...
function SDL_PeepEvents(events: PSDL_Event; numevents: LongInt; action: Uint32; minType, maxType: SDL_EventType): LongInt; cdecl; external;
...
function SDL_PollEvent(out event: TSDL_Event): LongInt; cdecl; external;
...
function SDL_GetEventFilter(out filter: TSDL_EventFilter; out userdata: Pointer): SDL_Bool; cdecl; external;
...
function SDL_LoadWAV_RW(src: PSDL_RWops; freesrc: LongInt; out spec: TSDL_AudioSpec;
  out audio_buf: PUint8; out audio_len: Uint32): PSDL_AudioSpec; cdecl; external;
...
procedure SDL_WaitThread(thread: PSDL_Thread; out status: LongInt); cdecl; external;
...
function SDL_GetPowerInfo(out secs, pct: LongInt): Uint32; cdecl; external;

...
procedure SDL_TTF_VERSION( var X : SDL_Version );
...
function TTF_RenderUNICODE_Solid( font : PTTF_Font;
				const text :PUint16; fg : SDL_Color ): PSDL_Surface;
...
function  TTF_RenderGlyph_Solid( font : PTTF_Font;
					ch : Uint16; fg : SDL_Color ): PSDL_Surface;
...
function TTF_RenderText_Shaded( font : PTTF_Font;
				const text : PChar; fg : SDL_Color; bg : SDL_Color ): PSDL_Surface;
...
function TTF_RenderUNICODE_Shaded( font : PTTF_Font;
				const text : PUint16; fg : SDL_Color; bg : SDL_Color ): PSDL_Surface;
...
function  TTF_RenderGlyph_Blended( font : PTTF_Font; ch : Uint16; fg : SDL_Color ): PSDL_Surface;

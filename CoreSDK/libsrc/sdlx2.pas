...
{$EXTERNALSYM SDL_ENABLE}
    ...
    {*< Surface is RLE encoded  }
      ...
      SDLK_LSUPER = SDLK_LMETA;    
      SDLK_RSUPER = SDLK_RMETA;
  ...
  function SDL_wcslen(_string:Pwchar_t):size_t;cdecl;external;
  function SDL_wcslcpy(dst:Pwchar_t; src:Pwchar_t; maxlen:size_t):size_t;cdecl;external;
  function SDL_wcslcat(dst:Pwchar_t; src:Pwchar_t; maxlen:size_t):size_t;cdecl;external;
  function SDL_utf8strlcpy(dst:Pchar; src:Pchar; dst_bytes:size_t):size_t;cdecl;external;
  function SDL_strrev(_string:Pchar):Pchar;cdecl;external;
  function SDL_strupr(_string:Pchar):Pchar;cdecl;external;
  function SDL_strlwr(_string:Pchar):Pchar;cdecl;external;
  function SDL_ltoa(value:longint; _string:Pchar; radix:longint):Pchar;cdecl;external;
  function SDL_ultoa(value:dword; _string:Pchar; radix:longint):Pchar;cdecl;external;
  function SDL_lltoa(value:Sint64; _string:Pchar; radix:longint):Pchar;cdecl;external;
  function SDL_ulltoa(value:Uint64; _string:Pchar; radix:longint):Pchar;cdecl;external;
  function SDL_iconv_open(tocode:Pchar; fromcode:Pchar):SDL_iconv_t;cdecl;external;
  function SDL_iconv_close(cd:SDL_iconv_t):longint;cdecl;external;
  function SDL_iconv(cd:SDL_iconv_t; inbuf:PPchar; inbytesleft:Psize_t; outbuf:PPchar; outbytesleft:Psize_t):size_t;cdecl;external;
  function SDL_iconv_string(tocode:Pchar; fromcode:Pchar; inbuf:Pchar; inbytesleft:size_t):Pchar;cdecl;external;
  function SDL_main(argc:longint; argv:PPchar):longint;cdecl;external;
  function SDL_ReportAssertion(_para1:PSDL_assert_data; _para2:Pchar; _para3:Pchar; _para4:longint):SDL_assert_state;cdecl;external;
  procedure SDL_SetAssertionHandler(handler:SDL_AssertionHandler; userdata:pointer);cdecl;external;
  function SDL_GetAssertionReport:PSDL_assert_data;cdecl;external;
  procedure SDL_ResetAssertionReport;cdecl;external;
  function SDL_AtomicTryLock(lock:PSDL_SpinLock):SDL_bool;cdecl;external;
  procedure SDL_AtomicLock(lock:PSDL_SpinLock);cdecl;external;
  procedure SDL_AtomicUnlock(lock:PSDL_SpinLock);cdecl;external;
  function SDL_AtomicCAS_(a:PSDL_atomic_t; oldval:longint; newval:longint):SDL_bool;cdecl;external;
  function SDL_AtomicCASPtr_(a:Ppointer; oldval:pointer; newval:pointer):SDL_bool;cdecl;external;
  procedure SDL_SetError(fmt:Pchar; args:array of const);cdecl;external;
  procedure SDL_SetError(fmt:Pchar);cdecl;external;
  function SDL_GetError:Pchar;cdecl;external;
  procedure SDL_ClearError;cdecl;external;
  procedure SDL_Error(code:SDL_errorcode);cdecl;external;
  function SDL_CreateMutex:PSDL_mutex;cdecl;external;
  function SDL_mutexP(mutex:PSDL_mutex):longint;cdecl;external;
  function SDL_mutexV(mutex:PSDL_mutex):longint;cdecl;external;
  ...
  function SDL_CreateThread(fn:SDL_ThreadFunction; name:Pchar; data:pointer):PSDL_Thread;cdecl;external;
  function SDL_GetThreadName(thread:PSDL_Thread):Pchar;cdecl;external;
  function SDL_ThreadID:SDL_Thread_ID;cdecl;external;
  function SDL_GetThreadID(thread:PSDL_Thread):SDL_Thread_ID;cdecl;external;
  function SDL_SetThreadPriority(priority:SDL_ThreadPriority):longint;cdecl;external;
  procedure SDL_WaitThread(thread:PSDL_Thread; status:Plongint);cdecl;external;
  function SDL_RWFromFile(fname:Pchar; mode:Pchar):PSDL_RWops;cdecl;external;
  function SDL_RWFromFP(fp:PFILE; autoclose:SDL_bool):PSDL_RWops;cdecl;external;
  function SDL_RWFromMem(mem:pointer; size:longint):PSDL_RWops;cdecl;external;
  function SDL_RWFromConstMem(mem:pointer; size:longint):PSDL_RWops;cdecl;external;
  function SDL_AllocRW:PSDL_RWops;cdecl;external;
  procedure SDL_FreeRW(area:PSDL_RWops);cdecl;external;
  function SDL_ReadLE16(src:PSDL_RWops):Uint16;cdecl;external;
  function SDL_ReadBE16(src:PSDL_RWops):Uint16;cdecl;external;
  function SDL_ReadLE32(src:PSDL_RWops):Uint32;cdecl;external;
  function SDL_ReadBE32(src:PSDL_RWops):Uint32;cdecl;external;
  function SDL_ReadLE64(src:PSDL_RWops):Uint64;cdecl;external;
  function SDL_ReadBE64(src:PSDL_RWops):Uint64;cdecl;external;
  function SDL_WriteLE16(dst:PSDL_RWops; value:Uint16):size_t;cdecl;external;
  function SDL_WriteBE16(dst:PSDL_RWops; value:Uint16):size_t;cdecl;external;
  function SDL_WriteLE32(dst:PSDL_RWops; value:Uint32):size_t;cdecl;external;
  function SDL_WriteBE32(dst:PSDL_RWops; value:Uint32):size_t;cdecl;external;
  function SDL_WriteLE64(dst:PSDL_RWops; value:Uint64):size_t;cdecl;external;
  function SDL_WriteBE64(dst:PSDL_RWops; value:Uint64):size_t;cdecl;external;
  function SDL_GetNumAudioDrivers:longint;cdecl;external;
  function SDL_GetAudioDriver(index:longint):Pchar;cdecl;external;
  function SDL_AudioInit(driver_name:Pchar):longint;cdecl;external;
  procedure SDL_AudioQuit;cdecl;external;
  function SDL_GetCurrentAudioDriver:Pchar;cdecl;external;
  function SDL_OpenAudio(desired:PSDL_AudioSpec; obtained:PSDL_AudioSpec):longint;cdecl;external;
  function SDL_GetNumAudioDevices(iscapture:longint):longint;cdecl;external;
  function SDL_GetAudioDeviceName(index:longint; iscapture:longint):Pchar;cdecl;external;
  function SDL_OpenAudioDevice(device:Pchar; iscapture:longint; desired:PSDL_AudioSpec; obtained:PSDL_AudioSpec; allowed_changes:longint):SDL_AudioDeviceID;cdecl;external;
  function SDL_GetAudioStatus:SDL_AudioStatus;cdecl;external;
  function SDL_GetAudioDeviceStatus(dev:SDL_AudioDeviceID):SDL_AudioStatus;cdecl;external;
  procedure SDL_PauseAudio(pause_on:longint);cdecl;external;
  procedure SDL_PauseAudioDevice(dev:SDL_AudioDeviceID; pause_on:longint);cdecl;external;
  function SDL_LoadWAV_RW(src:PSDL_RWops; freesrc:longint; spec:PSDL_AudioSpec; audio_buf:PPUint8; audio_len:PUint32):PSDL_AudioSpec;cdecl;external;
  ...
  function SDL_BuildAudioCVT(cvt:PSDL_AudioCVT; src_format:SDL_AudioFormat; src_channels:Uint8; src_rate:longint; dst_format:SDL_AudioFormat; 
             dst_channels:Uint8; dst_rate:longint):longint;cdecl;external;
  function SDL_ConvertAudio(cvt:PSDL_AudioCVT):longint;cdecl;external;
  procedure SDL_MixAudio(dst:PUint8; src:PUint8; len:Uint32; volume:longint);cdecl;external;
  procedure SDL_MixAudioFormat(dst:PUint8; src:PUint8; format:SDL_AudioFormat; len:Uint32; volume:longint);cdecl;external;
  procedure SDL_LockAudio;cdecl;external;
  procedure SDL_LockAudioDevice(dev:SDL_AudioDeviceID);cdecl;external;
  procedure SDL_UnlockAudio;cdecl;external;
  procedure SDL_UnlockAudioDevice(dev:SDL_AudioDeviceID);cdecl;external;
  procedure SDL_CloseAudio;cdecl;external;
  procedure SDL_CloseAudioDevice(dev:SDL_AudioDeviceID);cdecl;external;
  function SDL_AudioDeviceConnected(dev:SDL_AudioDeviceID):longint;cdecl;external;
  ...
  function SDL_HasSSE41:SDL_bool;cdecl;external;
  ...
  function SDL_PixelFormatEnumToMasks(format:Uint32; bpp:Plongint; Rmask:PUint32; Gmask:PUint32; Bmask:PUint32; 
             Amask:PUint32):SDL_bool;cdecl;external;
  function SDL_MasksToPixelFormatEnum(bpp:longint; Rmask:Uint32; Gmask:Uint32; Bmask:Uint32; Amask:Uint32):Uint32;cdecl;external;
  ...
  procedure SDL_CalculateGammaRamp(gamma:single; ramp:PUint16);cdecl;external;
  function SDL_HasIntersection(A:PSDL_Rect; B:PSDL_Rect):SDL_bool;cdecl;external;
  function SDL_IntersectRect(A:PSDL_Rect; B:PSDL_Rect; result:PSDL_Rect):SDL_bool;cdecl;external;
  procedure SDL_UnionRect(A:PSDL_Rect; B:PSDL_Rect; result:PSDL_Rect);cdecl;external;
  function SDL_EnclosePoints(points:PSDL_Point; count:longint; clip:PSDL_Rect; result:PSDL_Rect):SDL_bool;cdecl;external;
  function SDL_IntersectRectAndLine(rect:PSDL_Rect; X1:Plongint; Y1:Plongint; X2:Plongint; Y2:Plongint):SDL_bool;cdecl;external;
  function SDL_CreateRGBSurface(flags:Uint32; width:longint; height:longint; depth:longint; Rmask:Uint32; 
             Gmask:Uint32; Bmask:Uint32; Amask:Uint32):PSDL_Surface;cdecl;external;
  function SDL_CreateRGBSurfaceFrom(pixels:pointer; width:longint; height:longint; depth:longint; pitch:longint; 
             Rmask:Uint32; Gmask:Uint32; Bmask:Uint32; Amask:Uint32):PSDL_Surface;cdecl;external;
  ...
  function SDL_GetColorKey(surface:PSDL_Surface; key:PUint32):longint;cdecl;external;
  ...
  function SDL_SetSurfaceBlendMode(surface:PSDL_Surface; blendMode:SDL_BlendMode):longint;cdecl;external;
  function SDL_GetSurfaceBlendMode(surface:PSDL_Surface; blendMode:PSDL_BlendMode):longint;cdecl;external;
  function SDL_SetClipRect(surface:PSDL_Surface; rect:PSDL_Rect):SDL_bool;cdecl;external;
  procedure SDL_GetClipRect(surface:PSDL_Surface; rect:PSDL_Rect);cdecl;external;
  ...
  function SDL_FillRects(dst:PSDL_Surface; rects:PSDL_Rect; count:longint; color:Uint32):longint;cdecl;external;
  function SDL_UpperBlit(src:PSDL_Surface; srcrect:PSDL_Rect; dst:PSDL_Surface; dstrect:PSDL_Rect):longint;cdecl;external;
  function SDL_LowerBlit(src:PSDL_Surface; srcrect:PSDL_Rect; dst:PSDL_Surface; dstrect:PSDL_Rect):longint;cdecl;external;
  function SDL_SoftStretch(src:PSDL_Surface; srcrect:PSDL_Rect; dst:PSDL_Surface; dstrect:PSDL_Rect):longint;cdecl;external;
  function SDL_UpperBlitScaled(src:PSDL_Surface; srcrect:PSDL_Rect; dst:PSDL_Surface; dstrect:PSDL_Rect):longint;cdecl;external;
  function SDL_LowerBlitScaled(src:PSDL_Surface; srcrect:PSDL_Rect; dst:PSDL_Surface; dstrect:PSDL_Rect):longint;cdecl;external;
  function SDL_GetNumVideoDrivers:longint;cdecl;external;
  function SDL_GetVideoDriver(index:longint):Pchar;cdecl;external;
  function SDL_VideoInit(driver_name:Pchar):longint;cdecl;external;
  ...
  function SDL_GetDisplayBounds(displayIndex:longint; rect:PSDL_Rect):longint;cdecl;external;
  function SDL_GetNumDisplayModes(displayIndex:longint):longint;cdecl;external;
  function SDL_GetDisplayMode(displayIndex:longint; modeIndex:longint; mode:PSDL_DisplayMode):longint;cdecl;external;
  function SDL_GetDesktopDisplayMode(displayIndex:longint; mode:PSDL_DisplayMode):longint;cdecl;external;
  function SDL_GetCurrentDisplayMode(displayIndex:longint; mode:PSDL_DisplayMode):longint;cdecl;external;
  function SDL_GetClosestDisplayMode(displayIndex:longint; mode:PSDL_DisplayMode; closest:PSDL_DisplayMode):PSDL_DisplayMode;cdecl;external;
  function SDL_GetWindowDisplay(window:PSDL_Window):longint;cdecl;external;
  function SDL_SetWindowDisplayMode(window:PSDL_Window; mode:PSDL_DisplayMode):longint;cdecl;external;
  function SDL_GetWindowDisplayMode(window:PSDL_Window; mode:PSDL_DisplayMode):longint;cdecl;external;
  ...
  function SDL_CreateWindow(title:Pchar; x:longint; y:longint; w:longint; h:longint; 
             flags:Uint32):PSDL_Window;cdecl;external;
  ...
  procedure SDL_SetWindowTitle(window:PSDL_Window; title:Pchar);cdecl;external;
  ...
  function SDL_SetWindowData(window:PSDL_Window; name:Pchar; userdata:pointer):pointer;cdecl;external;
  function SDL_GetWindowData(window:PSDL_Window; name:Pchar):pointer;cdecl;external;
  procedure SDL_SetWindowPosition(window:PSDL_Window; x:longint; y:longint);cdecl;external;
  procedure SDL_GetWindowPosition(window:PSDL_Window; x:Plongint; y:Plongint);cdecl;external;
  procedure SDL_SetWindowSize(window:PSDL_Window; w:longint; h:longint);cdecl;external;
  procedure SDL_GetWindowSize(window:PSDL_Window; w:Plongint; h:Plongint);cdecl;external;
  ...
  function SDL_SetWindowBrightness(window:PSDL_Window; brightness:single):longint;cdecl;external;
  function SDL_GetWindowBrightness(window:PSDL_Window):single;cdecl;external;
  function SDL_SetWindowGammaRamp(window:PSDL_Window; red:PUint16; green:PUint16; blue:PUint16):longint;cdecl;external;
  function SDL_GetWindowGammaRamp(window:PSDL_Window; red:PUint16; green:PUint16; blue:PUint16):longint;cdecl;external;
  ...
  function SDL_GL_GetProcAddress(proc:Pchar):pointer;cdecl;external;
  procedure SDL_GL_UnloadLibrary;cdecl;external;
  function SDL_GL_ExtensionSupported(extension:Pchar):SDL_bool;cdecl;external;
  function SDL_GL_SetAttribute(attr:SDL_GLattr; value:longint):longint;cdecl;external;
  function SDL_GL_GetAttribute(attr:SDL_GLattr; value:Plongint):longint;cdecl;external;
  function SDL_GL_CreateContext(window:PSDL_Window):SDL_GLContext;cdecl;external;
  function SDL_GL_MakeCurrent(window:PSDL_Window; context:SDL_GLContext):longint;cdecl;external;
  ...
  procedure SDL_GL_DeleteContext(context:SDL_GLContext);cdecl;external;
  ...
  function SDL_GetModState:SDL_Keymod;cdecl;external;
  procedure SDL_SetModState(modstate:SDL_Keymod);cdecl;external;
  function SDL_GetKeyFromScancode(scancode:SDL_Scancode):SDL_Keycode;cdecl;external;
  function SDL_GetScancodeFromKey(key:SDL_Keycode):SDL_Scancode;cdecl;external;
  function SDL_GetScancodeName(scancode:SDL_Scancode):Pchar;cdecl;external;
  function SDL_GetScancodeFromName(name:Pchar):SDL_Scancode;cdecl;external;
  function SDL_GetKeyName(key:SDL_Keycode):Pchar;cdecl;external;
  function SDL_GetKeyFromName(name:Pchar):SDL_Keycode;cdecl;external;
  procedure SDL_StartTextInput;cdecl;external;
  procedure SDL_StopTextInput;cdecl;external;
  procedure SDL_SetTextInputRect(rect:PSDL_Rect);cdecl;external;
  function SDL_GetMouseFocus:PSDL_Window;cdecl;external;
  function SDL_GetMouseState(x:Plongint; y:Plongint):Uint8;cdecl;external;
  function SDL_GetRelativeMouseState(x:Plongint; y:Plongint):Uint8;cdecl;external;
  procedure SDL_WarpMouseInWindow(window:PSDL_Window; x:longint; y:longint);cdecl;external;
  ...
  function SDL_JoystickName(device_index:longint):Pchar;cdecl;external;
  function SDL_JoystickOpen(device_index:longint):PSDL_Joystick;cdecl;external;
  function SDL_JoystickOpened(device_index:longint):longint;cdecl;external;
  function SDL_JoystickIndex(joystick:PSDL_Joystick):longint;cdecl;external;
  ...
  function SDL_JoystickGetBall(joystick:PSDL_Joystick; ball:longint; dx:Plongint; dy:Plongint):longint;cdecl;external;
  ...
  function SDL_GetTouch(id:SDL_TouchID):PSDL_Touch;cdecl;external;
  function SDL_GetFinger(touch:PSDL_Touch; id:SDL_FingerID):PSDL_Finger;cdecl;external;
  function SDL_RecordGesture(touchId:SDL_TouchID):longint;cdecl;external;
  function SDL_SaveAllDollarTemplates(src:PSDL_RWops):longint;cdecl;external;
  function SDL_SaveDollarTemplate(gestureId:SDL_GestureID; src:PSDL_RWops):longint;cdecl;external;
  function SDL_LoadDollarTemplates(touchId:SDL_TouchID; src:PSDL_RWops):longint;cdecl;external;
  procedure SDL_PumpEvents;cdecl;external;
  function SDL_PeepEvents(events:PSDL_Event; numevents:longint; action:SDL_eventaction; minType:Uint32; maxType:Uint32):longint;cdecl;external;
  function SDL_HasEvent(_type:Uint32):SDL_bool;cdecl;external;
  function SDL_HasEvents(minType:Uint32; maxType:Uint32):SDL_bool;cdecl;external;
  ...
  function SDL_PollEvent(event:PSDL_Event):longint;cdecl;external;
  function SDL_WaitEvent(event:PSDL_Event):longint;cdecl;external;
  function SDL_WaitEventTimeout(event:PSDL_Event; timeout:longint):longint;cdecl;external;
  function SDL_PushEvent(event:PSDL_Event):longint;cdecl;external;
  procedure SDL_SetEventFilter(filter:SDL_EventFilter; userdata:pointer);cdecl;external;
  function SDL_GetEventFilter(filter:PSDL_EventFilter; userdata:Ppointer):SDL_bool;cdecl;external;
  procedure SDL_AddEventWatch(filter:SDL_EventFilter; userdata:pointer);cdecl;external;
  procedure SDL_DelEventWatch(filter:SDL_EventFilter; userdata:pointer);cdecl;external;
  procedure SDL_FilterEvents(filter:SDL_EventFilter; userdata:pointer);cdecl;external;
  function SDL_EventState(_type:Uint32; state:longint):Uint8;cdecl;external;
  function SDL_RegisterEvents(numevents:longint):Uint32;cdecl;external;
  function SDL_SetHintWithPriority(name:Pchar; value:Pchar; priority:SDL_HintPriority):SDL_bool;cdecl;external;
  function SDL_SetHint(name:Pchar; value:Pchar):SDL_bool;cdecl;external;
  function SDL_GetHint(name:Pchar):Pchar;cdecl;external;
  procedure SDL_ClearHints;cdecl;external;
  function SDL_LoadObject(sofname:Pchar):pointer;cdecl;external;
  function SDL_LoadFunction(handle:pointer; name:Pchar):pointer;cdecl;external;
  procedure SDL_UnloadObject(handle:pointer);cdecl;external;
  procedure SDL_LogSetAllPriority(priority:SDL_LogPriority);cdecl;external;
  procedure SDL_LogSetPriority(category:longint; priority:SDL_LogPriority);cdecl;external;
  function SDL_LogGetPriority(category:longint):SDL_LogPriority;cdecl;external;
  ...
  procedure SDL_LogMessage(category:longint; priority:SDL_LogPriority; fmt:Pchar; args:array of const);cdecl;external;
  procedure SDL_LogMessage(category:longint; priority:SDL_LogPriority; fmt:Pchar);cdecl;external;
  procedure SDL_LogMessageV(category:longint; priority:SDL_LogPriority; fmt:Pchar);cdecl;varargs; external;
  procedure SDL_LogGetOutputFunction(callback:PSDL_LogOutputFunction; userdata:Ppointer);cdecl;external;
  procedure SDL_LogSetOutputFunction(callback:SDL_LogOutputFunction; userdata:pointer);cdecl;external;
  function SDL_GetPowerInfo(secs:Plongint; pct:Plongint):SDL_PowerState;cdecl;external;
  function SDL_GetNumRenderDrivers:longint;cdecl;external;
  function SDL_GetRenderDriverInfo(index:longint; info:PSDL_RendererInfo):longint;cdecl;external;
  ...
  function SDL_SetTextureBlendMode(texture:PSDL_Texture; blendMode:SDL_BlendMode):longint;cdecl;external;
  ...
  function SDL_RenderSetViewport(renderer:PSDL_Renderer; rect:PSDL_Rect):longint;cdecl;external;
  procedure SDL_RenderGetViewport(renderer:PSDL_Renderer; rect:PSDL_Rect);cdecl;external;
  ...
  function SDL_SetRenderDrawBlendMode(renderer:PSDL_Renderer; blendMode:SDL_BlendMode):longint;cdecl;external;
  ...
  function SDL_RenderDrawPoint(renderer:PSDL_Renderer; x:longint; y:longint):longint;cdecl;external;
  function SDL_RenderDrawPoints(renderer:PSDL_Renderer; points:PSDL_Point; count:longint):longint;cdecl;external;
  function SDL_RenderDrawLine(renderer:PSDL_Renderer; x1:longint; y1:longint; x2:longint; y2:longint):longint;cdecl;external;
  function SDL_RenderDrawLines(renderer:PSDL_Renderer; points:PSDL_Point; count:longint):longint;cdecl;external;
  function SDL_RenderDrawRect(renderer:PSDL_Renderer; rect:PSDL_Rect):longint;cdecl;external;
  function SDL_RenderDrawRects(renderer:PSDL_Renderer; rects:PSDL_Rect; count:longint):longint;cdecl;external;
  function SDL_RenderFillRect(renderer:PSDL_Renderer; rect:PSDL_Rect):longint;cdecl;external;
  function SDL_RenderFillRects(renderer:PSDL_Renderer; rects:PSDL_Rect; count:longint):longint;cdecl;external;
  function SDL_RenderCopy(renderer:PSDL_Renderer; texture:PSDL_Texture; srcrect:PSDL_Rect; dstrect:PSDL_Rect):longint;cdecl;external;
  function SDL_RenderReadPixels(renderer:PSDL_Renderer; rect:PSDL_Rect; format:Uint32; pixels:pointer; pitch:longint):longint;cdecl;external;
  ...
  function SDL_AddTimer(interval:Uint32; callback:SDL_TimerCallback; param:pointer):SDL_TimerID;cdecl;external;
  function SDL_RemoveTimer(t:SDL_TimerID):SDL_bool;cdecl;external;
  procedure SDL_GetVersion(ver:PSDL_version);cdecl;external;
  function SDL_GetRevision:Pchar;cdecl;external;
  function SDL_GetRevisionNumber:longint;cdecl;external;
  ...
  function SDL_Linked_Version:PSDL_version;cdecl;external;
  function SDL_AudioDriverName(namebuf:Pchar; maxlen:longint):Pchar;cdecl;external;
  function SDL_VideoDriverName(namebuf:Pchar; maxlen:longint):Pchar;cdecl;external;
  function SDL_GetVideoInfo:PSDL_VideoInfo;cdecl;external;
  function SDL_VideoModeOK(width:longint; height:longint; bpp:longint; flags:Uint32):longint;cdecl;external;
  function SDL_ListModes(format:PSDL_PixelFormat; flags:Uint32):PPSDL_Rect;cdecl;external;
  function SDL_SetVideoMode(width:longint; height:longint; bpp:longint; flags:Uint32):PSDL_Surface;cdecl;external;
  function SDL_GetVideoSurface:PSDL_Surface;cdecl;external;
  procedure SDL_UpdateRects(screen:PSDL_Surface; numrects:longint; rects:PSDL_Rect);cdecl;external;
  procedure SDL_UpdateRect(screen:PSDL_Surface; x:Sint32; y:Sint32; w:Uint32; h:Uint32);cdecl;external;
  function SDL_Flip(screen:PSDL_Surface):longint;cdecl;external;
  function SDL_SetAlpha(surface:PSDL_Surface; flag:Uint32; alpha:Uint8):longint;cdecl;external;
  ...
  procedure SDL_WM_GetCaption(title:PPchar; icon:PPchar);cdecl;external;
  procedure SDL_WM_SetIcon(icon:PSDL_Surface; mask:PUint8);cdecl;external;
  function SDL_WM_IconifyWindow:longint;cdecl;external;
  function SDL_WM_ToggleFullScreen(surface:PSDL_Surface):longint;cdecl;external;
  function SDL_WM_GrabInput(mode:SDL_GrabMode):SDL_GrabMode;cdecl;external;
  function SDL_SetPalette(surface:PSDL_Surface; flags:longint; colors:PSDL_Color; firstcolor:longint; ncolors:longint):longint;cdecl;external;
  function SDL_SetColors(surface:PSDL_Surface; colors:PSDL_Color; firstcolor:longint; ncolors:longint):longint;cdecl;external;
  function SDL_GetWMInfo(info:PSDL_SysWMinfo):longint;cdecl;external;
  function SDL_GetAppState:Uint8;cdecl;external;
  procedure SDL_WarpMouse(x:Uint16; y:Uint16);cdecl;external;
  function SDL_CreateYUVOverlay(width:longint; height:longint; format:Uint32; display:PSDL_Surface):PSDL_Overlay;cdecl;external;
  function SDL_LockYUVOverlay(overlay:PSDL_Overlay):longint;cdecl;external;
  procedure SDL_UnlockYUVOverlay(overlay:PSDL_Overlay);cdecl;external;
  function SDL_DisplayYUVOverlay(overlay:PSDL_Overlay; dstrect:PSDL_Rect):longint;cdecl;external;
  procedure SDL_FreeYUVOverlay(overlay:PSDL_Overlay);cdecl;external;
  procedure SDL_GL_SwapBuffers;cdecl;external;
  function SDL_SetGamma(red:single; green:single; blue:single):longint;cdecl;external;
  function SDL_SetGammaRamp(red:PUint16; green:PUint16; blue:PUint16):longint;cdecl;external;
  function SDL_GetGammaRamp(red:PUint16; green:PUint16; blue:PUint16):longint;cdecl;external;
  function SDL_EnableKeyRepeat(delay:longint; interval:longint):longint;cdecl;external;
  procedure SDL_GetKeyRepeat(delay:Plongint; interval:Plongint);cdecl;external;
  function SDL_EnableUNICODE(enable:longint):longint;cdecl;external;
  function SDL_SetTimer(interval:Uint32; callback:SDL_OldTimerCallback):longint;cdecl;external;
  function SDL_putenv(variable:Pchar):longint;cdecl;external;

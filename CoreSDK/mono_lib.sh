...
doCompile()
{
	...
	/usr/bin/libtool -install_name ./libSGSDK.dylib  -arch_only ${1} -dynamic -L"${Output}" -search_paths_first -multiply_defined suppress -o "$Output/libSGSDK${1}.dylib" `cat ./src/maclink${1}.res` `cat ./src/dotnetlink.res` -current_version 2.0

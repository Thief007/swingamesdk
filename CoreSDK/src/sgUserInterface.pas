...
///
/// @class Panel
/// @method ToggleCheckboxStateWithID%s
...
///
/// @class Panel
/// @method ActiveRadioButtonIndexWithID%s
...
/// @lib 
/// @class Dialog
/// @overload ShowSaveDialog ShowSaveDialogWithFolderOptions
...
/// @lib 
/// @class Dialog
/// @overload ShowOpenDialog ShowOpenDialogWithFolderOptions

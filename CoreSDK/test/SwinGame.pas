...
interface
uses sgTypes, sgAnimations, sgAudio, sgCamera, sgCharacters, sgGeometry, sgGraphics, sgImages, sgInput, sgPhysics, sgResources, sgSprites, sgText, sgTimers, sgUtils, sgUserInterface;
  ...
  procedure ListSetFont(lst: GUITextbox; f: Font); overload;
  ...
  procedure MovePanel(p: Panel; mvmt: Vector); overload;
  ...
  function PanelAtPoint(pt: Point2D): Panel; overload;

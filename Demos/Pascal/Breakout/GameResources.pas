...
implementation
  ...
  // - Loads the game's fonts
	...
	begin
		...
		NewFont('ArialMed', 'arial.ttf', 40);
		NewFont('Courier', 'cour.ttf', 16);
		NewFont('ArialSmall','arial.ttf',14);
		NewFont('UnrealL','UnrealT.ttf',80);
		NewFont('Unreal','UnrealT.ttf',40);
		NewFont('28day','28 days later.ttf',50);
		NewFont('abstract','ABSTRACT.ttf',10);
		NewFont('absmall','ABSTRACT.ttf',5);
  ...
  // - Loads the game's images
    ...
    //TODO: Add code here to load the images you want to use
		...
		NewImage('brick4','brick4.png');
		NewImage('brick5','brick5.png');
		NewImage('background','bg.jpg');
		NewImage('menubg','menus.png');
	end;

...
Module MenuController
    ...
    Public Sub DrawMainMenu()
        ...
        'Text.DrawText("Main Menu", Color.White, GameFont("ArialLarge"), 50, 50)
    ...
    Public Sub DrawGameMenu()
        'Clears the Screen to Black
        'Text.DrawText("Paused", Color.White, GameFont("ArialLarge"), 50, 50)
    ...
    Public Sub DrawSettings()
        'Clears the Screen to Black
        'Text.DrawText("Settings", Color.White, GameFont("ArialLarge"), 50, 50)
    ...
    Private Sub DrawButtons(ByVal menu As Integer, ByVal level As Integer, ByVal xOffset As Integer)
        ...
        For i As Integer = 0 To _menuStructure(menu).Length - 1
            ...
            'Graphics.FillRectangle(Color.White, btnLeft, btnTop, BUTTON_WIDTH, BUTTON_HEIGHT)

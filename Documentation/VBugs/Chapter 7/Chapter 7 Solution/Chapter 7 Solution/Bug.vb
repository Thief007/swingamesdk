Public Class Bug
    ...
    End Property
    Public Sub New()
        'this is the constructor for each new bug, this is read first
        Alive = True
    ...
    End Sub
    Public Sub Draw()
        'draws the living bug or the dead bug
        If IsAlive Then
    ...
    End Sub
    Public Sub Update()
        'updates the sprite to and checks if it is alive
        If IsAlive Then
    ...
    Private Sub CheckCollisions()
        'Checks to see if the bug has hit a wall

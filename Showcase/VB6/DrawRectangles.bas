...
Public Sub DrawRectangles()
    ...
    Do Until SwinGame.MouseAndKey.IsKeyPressed(Keys_VK_N)
        Call Randomize
        Call SwinGame.Graphics.DrawRectangleOnScreen(Colour.GetRandomColour, (Rnd * 800), (Rnd * 800), (Rnd * 800), (Rnd * 800))
        Call SwinGame.Graphics.FillRectangleOnScreen(Colour.GetRandomColour, (Rnd * 800), (Rnd * 800), (Rnd * 800), (Rnd * 800))

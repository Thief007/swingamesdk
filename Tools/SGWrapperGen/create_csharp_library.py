...
_struct_type_switcher = {
    #Pascal type: what it maps to
    'single': 'private float %s',
    'longint': 'private int %s',
    'soundeffect': 'private SoundEffect %s',
    'music': 'private Music %s',
    'string': 'private string %s',
    'boolean': 'private bool %s',
    'byte': 'private byte %s',
    'timer': 'private Timer %s',
    'color': 'private Color %s',
    'resourcekind': 'private ResourceKind %s',
    'uint32': 'private uint %s',
    'bitmap': 'private Bitmap %s',
    #'pointer': 'private IntPtr %s',
    'single[0..2][0..2]': '[ MarshalAs( UnmanagedType.ByValArray, SizeConst=9 )]\nprivate float[,] %s',
    # '^bitmapdata': 'private BitmapData *%s',
    # '^spritedata': 'private SpriteData *%s',
    # '^timerdata': 'private TimerData *%s',
    # 'psdl_surface': 'private IntPtr %s',
    # 'boolean[0..n - 1][0..n - 1]': 'private bool[,] %s',
    # 'bitmap[0..n - 1]': 'private Bitmap[] %s',
    # 'spritekind': 'private SpriteKind %s',
    # 'longint[0..n - 1]': 'private int[] %s',
    'vector': 'private Vector %s',
    # 'spriteendingaction': 'private SpriteEndingAction %s',
    'point2d': 'private Point2D %s',
    # '^point2d': 'private Point2D *%s',
    'point2d[0..2]': '[ MarshalAs( UnmanagedType.ByValArray, SizeConst=3 )]\nprivate Point2D[] %s',
    # 'point2d[0..n - 1]': 'private Point2D[] %s',
    # '^linesegment': 'private LineSegment *%s',
    'linesegment': 'private LineSegment %s',
    'sprite': 'private Sprite %s',
    'rectangle': 'private Rectangle %s',
    #'triangle': 'private Triangle %s',
    'linesarray': 'private LineSegment[] %s',
    # 'linesegmentptr': 'private LineSegment *%s',
    'font': 'private Font %s',
    'fontalignment': 'private FontAlignment %s',
    'fontstyle': 'private FontStyle %s',
    'mousebutton': 'private MouseButton %s',
    'uint16': 'private ushort %s',
    # '^single': 'private float *%s',
    'keycode': 'private KeyCode %s',
    # 'bitmapptr': 'private Bitmap *%s',
    # '^bitmap': 'private Bitmap *%s',
    # 'longintptr': 'private int *%s',
    # '^longint': 'private int *%s',
    'collisionside': 'private CollisionSide %s',
    'longint[0..n - 1][0..n - 1]': 'private int[][] %s',
    'mapdata': 'private MapData %s',
    'animationdata[0..n - 1]': 'private AnimationData[] %s',
    'layerdata[0..n - 1]': 'private LayerData[] %s',
    'collisiondata': 'private CollisionData %s',
    'map': 'private Map %s',
    'maptag': 'private MapTag %s',
    'maptile': 'private MapTile %s',
    'circle': 'private Circle %s',
    'arrayofpoint2d': 'private Point2D[] %s',
}

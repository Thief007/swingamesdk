...
class PascalMetaComment(object):
    ...
    def __init__(self, tokens):
        ...
        self._attribute_processors = {
            ...
            #'lib'                       : self.process_lib_attribute, TODO: implement -> also find out what it's for...
    ...
    def process_idlist_attribute(self, token):
        ...
        eg. @see id1, id2 ...
        '''
        tok = self._tokens.match_token(TokenKind.TokenIdentifier)
        ids = [tok.value]
    ...
    def process_id_list_and_comment_attribute(self, token):
        ...
        param_toks.append(self._match_token(TokenKind.Identifier).value)
